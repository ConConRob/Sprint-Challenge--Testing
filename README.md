...
"Describe" breaks the test into suites while "it" does the individual tests

1. What is the point of `Test Driven Development`? What do you think about this approach?

The point is to build a more robust product that can scale better. I think it is a bit awkward to learn but it seems to help build better functions or components.
